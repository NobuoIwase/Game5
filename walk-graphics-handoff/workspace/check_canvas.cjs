...
const html=fs.readFileSync('lumina-walk-v1/lumina-walk-player.html','utf8');
...
setTimeout(()=>{
 try{
  ...
  fs.writeFileSync('canvas-parts-check.png',png());els.parts.click();
  ...
  fs.writeFileSync('canvas-front-check.png',png());fs.writeFileSync('canvas-side-check.png',els.side.canvas.toBuffer('image/png'));
