...
head_corrections={
 'down_right':('down-head-v7.png',[26,60]),
 'up_right':('up-head-v7.png',[26,60])}
...
# The diagonals' C7 attachment is inside the existing neck base, between
# the shoulders, rather than above the torso's painted neck.
for view in ['down_right','up_right']:
    torso=assets[view]['upper_body']
    torso['cervical_socket']=[torso['neck_socket'][0],9]
