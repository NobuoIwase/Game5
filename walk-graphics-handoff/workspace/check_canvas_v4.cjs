...
const html=fs.readFileSync('lumina-walk-v4/lumina-walk-player.html','utf8');
...
setTimeout(()=>{
 try{
  ...
  fs.writeFileSync('canvas-parts-v4-check.png',png());els.parts.click();
  ...
  fs.writeFileSync('canvas-front-v4-check.png',png());fs.writeFileSync('canvas-side-v4-check.png',els.side.canvas.toBuffer('image/png'));
