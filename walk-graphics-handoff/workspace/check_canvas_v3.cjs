...
const html=fs.readFileSync('lumina-walk-v3/lumina-walk-player.html','utf8');
...
setTimeout(()=>{
 try{
  ...
  fs.writeFileSync('canvas-parts-v3-check.png',png());els.parts.click();
  ...
  fs.writeFileSync('canvas-front-v3-check.png',png());fs.writeFileSync('canvas-side-v3-check.png',els.side.canvas.toBuffer('image/png'));
