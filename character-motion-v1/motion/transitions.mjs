...
stand@scout>scout_sidestep scout_sidestep>stand@scout stand@scout>scout_dash_stop scout_dash_stop>stand@scout stand@scout>scout_tail_grabbed scout_tail_grabbed>stand@scout stand@scout>scout_pack_adjust scout_pack_adjust>stand@scout stand@scout>scout_tension scout_tension>sit_afterglow scout_tail_grabbed>scout_tension
stand@mage>mage_barrier mage_barrier>stand@mage mage_bolt>mage_overheat mage_overheat>stand@mage stand@mage>mage_hat_tug mage_hat_tug>stand@mage stand@mage>mage_arms_bound mage_arms_bound>break_free mage_arms_bound>mage_suppress_tension mage_suppress_tension>mage_recover mage_recover>stand@mage
stand@healer>healer_kneel_heal healer_kneel_heal>stand@healer stand@healer>healer_purify healer_purify>stand@healer stand@healer>healer_panel_catch healer_panel_catch>healer_cover stand@healer>healer_run_cover healer_run_cover>healer_panel_catch healer_run_cover>stand@healer stand@healer>healer_dark_prayer healer_dark_prayer>stand@healer healer_disgust>healer_tension_refuse healer_tension_refuse>sit_recover
