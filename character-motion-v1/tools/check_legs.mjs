...
import {library as A} from '../motion/attack.mjs';import {library as R} from '../motion/restraint.mjs';import {library as S} from '../motion/scenes.mjs';
let n=0;
for(const lib of [A(),R(),S()])for(const [m,byDir] of Object.entries(lib.poses))byDir.front.forEach((fr,i)=>{const J=fr.joints,x=k=>J[k].world[0];
