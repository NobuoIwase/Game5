...
| 斥候（シーフ） | 230 | 68 | 955 | 204 | 92枚 |
| 魔法使い | 208 | 58 | 954 | 229 | 85枚 |
| ヒーラー | 204 | 59 | 816 | 218 | 87枚 |

- 曲げた肘・膝の絵（28枚）と手の形（3種類×方向）も、キャラクターごとに要る
...
| ほかのヒロイン | 204 | 15 | 735 | 130 | 1084 |
| つなぎ | 0 | 21 | 380 | 100 | 501 |

**比べると**
- すべて1枚絵：新規1279コマ＋部分描き替え52コマ
- すべて組み立て：部位の絵107枚だけで済むが、動きの要のコマまで組み立てになり、硬く見える
- この計画：要のコマ494枚を1枚絵にし、89コマは組み立てたあとに描き足す
...
4. **曲げた肘・膝は専用の絵**
   - 60度を超えて曲げる肘・膝は、曲げた形の関節の絵（上の28枚）を使う
...
| `scout_sidestep` | 13（各方向 3, 5 コマ目） | 0 | 43 | 8 |
| `scout_dash_stop` | 4（0, 4, 7, 9） | 0 | 6 | 0 |
| `scout_tail_grabbed` | 4（0, 1, 5, 7） | 0 | 4 | 0 |
| `scout_pack_adjust` | 1（3） | 0 | 8 | 2 |
| `scout_tension` | 3（0, 2, 8） | 2（3, 4） | 4 | 0 |
| `mage_barrier` | 8（各方向 4 コマ目） | 0 | 56 | 16 |
| `mage_overheat` | 2（0, 2） | 0 | 7 | 3 |
| `mage_hat_tug` | 1（5） | 0 | 10 | 1 |
| `mage_arms_bound` | 2（0, 2） | 0 | 3 | 3 |
| `mage_recover` | 2（3, 8） | 1（1） | 9 | 2 |
| `healer_kneel_heal` | 1（0） | 0 | 2 | 5 |
| `healer_purify` | 21（各方向 3, 9 コマ目） | 0 | 67 | 16 |
| `healer_panel_catch` | 2（3, 6） | 0 | 6 | 1 |
| `healer_run_cover` | 2（0, 4） | 0 | 6 | 0 |
| `healer_dark_prayer` | 1（5） | 0 | 10 | 2 |
| `healer_tension_refuse` | 3（0, 2, 7） | 2（5, 6） | 3 | 0 |
...
| `stand@scout__scout_sidestep` | 0 | 0 | 3 | 0 |
| `scout_sidestep__stand@scout` | 0 | 0 | 4 | 0 |
| `stand@scout__scout_dash_stop` | 0 | 0 | 4 | 0 |
| `stand@scout__scout_tail_grabbed` | 0 | 0 | 1 | 3 |
| `scout_tail_grabbed__stand@scout` | 0 | 0 | 8 | 0 |
| `stand@scout__scout_tension` | 0 | 0 | 3 | 0 |
| `scout_tension__sit_afterglow` | 0 | 2（0, 1） | 0 | 0 |
| `scout_tail_grabbed__scout_tension` | 0 | 0 | 8 | 0 |
| `mage_bolt__mage_overheat` | 0 | 0 | 3 | 0 |
| `stand@mage__mage_arms_bound` | 0 | 0 | 18 | 0 |
| `mage_arms_bound__break_free` | 0 | 0 | 15 | 0 |
| `mage_arms_bound__mage_suppress_tension` | 0 | 0 | 19 | 1 |
| `stand@healer__healer_kneel_heal` | 0 | 0 | 3 | 0 |
| `healer_kneel_heal__stand@healer` | 0 | 0 | 1 | 2 |
| `stand@healer__healer_run_cover` | 0 | 0 | 3 | 0 |
| `healer_run_cover__healer_panel_catch` | 0 | 0 | 3 | 0 |
| `healer_run_cover__stand@healer` | 0 | 0 | 1 | 2 |
| `healer_tension_refuse__sit_recover` | 0 | 2（0, 1） | 0 | 0 |
