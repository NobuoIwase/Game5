...
const html=fs.readFileSync('lumina-walk-v2/lumina-walk-player.html','utf8');
...
setTimeout(()=>{
 try{
  ...
  fs.writeFileSync('canvas-parts-v2-check.png',png());els.parts.click();
  ...
  fs.writeFileSync('canvas-front-v2-check.png',png());fs.writeFileSync('canvas-side-v2-check.png',els.side.canvas.toBuffer('image/png'));
