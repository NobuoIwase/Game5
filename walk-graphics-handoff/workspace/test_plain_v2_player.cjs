...
const html=fs.readFileSync('plain-walk-v2/plain-walk-player.html','utf8'),els={};let downloaded=null,lastBlob=null;
...
setTimeout(async()=>{try{
 ...
 fs.writeFileSync('plain-v2-player-side-check.png',png('side'));fs.writeFileSync('plain-v2-player-parts-check.png',png('partsSide'));
