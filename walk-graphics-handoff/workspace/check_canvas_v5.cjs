...
const html=fs.readFileSync('lumina-walk-v5/lumina-walk-player.html','utf8');
...
setTimeout(()=>{
 try{
  ...
  fs.writeFileSync('canvas-parts-v5-check.png',png());els.parts.click();
  ...
  fs.writeFileSync('canvas-front-v5-check.png',png());fs.writeFileSync('canvas-side-v5-check.png',els.side.canvas.toBuffer('image/png'));
