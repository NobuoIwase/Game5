...
for bones in [False,True]:
    ...
    for f in range(8):
        ...
        d.text((423,548),'Spine / hip / knee joints' if bones else 'Relaxed arms / heel contact',font=small,fill=(144,223,207))
        preview.append(p)
...
overview=Image.new('RGB',(1200,930),(32,35,45));d=ImageDraw.Draw(overview)
for row,v in enumerate(['front','side']):
    d.text((18,row*540+12),v.upper(),font=font,fill=(144,223,207))
