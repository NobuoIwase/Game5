...
# Diagonal skull bases attach inside the rear underside of the head, rather
# than at the lowest silhouette pixel. Preserve the cervical skeleton while
# letting each view overlap the neck/shoulders at its own visible height.
for view,pivot in {'down_right':[31.5,57],'up_right':[33,55]}.items():
    assets[view]['head']['pivot']=pivot
    assets[view]['head']['attachment']='skull_base'
